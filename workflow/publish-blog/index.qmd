...
![](quartopub-steps/1-auth.png){fig.alt="Authentication step for Quarto Pub"}

Next, it will ask what provider you'd like:

![](quartopub-steps/2-provider.png){fig.alt="Provider step for Quarto Pub"}
Then what account you'd like the site under:

![](quartopub-steps/3-account.png){fig.alt="Provider step for Quarto Pub"}

Finally, the name of your site:

![](quartopub-steps/4-name.png){fig.alt="Selecting a name step for Quarto Pub"}

Now your blog is online! Here, you can edit the slug and delete the site.

![](quartopub-steps/5-site.png){fig.alt="Rendered Quarto Pub site"}
